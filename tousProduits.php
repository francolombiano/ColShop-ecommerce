...
<main>
     <!--Image de fond  -->
     <div class="affiche-tous-produits"></div>
     ...
     <div class="general col-sm-12 col-md-12 col-lg-12 container-fluid bg-light p-5">
          <div class="row">
               <div class="info col-sm-12 col-md-12 text-center mb-5">
                    <h1 class="display-5 fw-bolder text-secondary">ColShop - Tous les produits!</h1>
          ...
          <!-- produits -->
          <section class="container-fluid medias articles col-sm-12 pt-3 pb-3 text-center">
               <div class="row">
